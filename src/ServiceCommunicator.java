    ...
    //
      public static void main(String[] argv) {
        ...
        System.out.println(new ServiceCommunicator("https://itunes.apple.com/search?term=" + "bbking" + "\\&limit=1").get());
          System.out.println(new ServiceCommunicator("https://itunes.apple.com/search?term=" + "Lianne-La-Havas"));
        System.out.println(new ServiceCommunicator("http://api.tvmaze.com/singlesearch/shows?q=" + "Moesha").get());
        System.err.println("==================================");
